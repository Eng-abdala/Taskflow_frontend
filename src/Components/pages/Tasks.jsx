...
const Tasks = () => {
    const [tasks, setTasks] = useState([]);
...

        {
            tasks.map((task)=>{
                return <div >
                <div className=" p-2 shadow-blue-300 shadow-2xl rounded-lg relative  mt-2 w-[260px] h-[180px]">
                    ...
                    <i onClick={()=>deleteTask(task._id)}  class="fa-solid fa-trash text-[20px] text-red-500"></i>
                  <Link to={'/updatetask/'+task._id}>  <i class="fa-solid fa-pencil text-[20px] text-blue-500"></i> </Link>
                    </div>
                </div>
